...
static GLfloat_glmMax(GLfloat a, GLfloat b)
{
  if (a > b)
    return a;
  return b;
  ...
  static GLfloat_glmAbs(GLfloat f)
{
  if (f < 0)
    return -f;
  return f;
  ...
  static GLfloat_glmDot(GLfloat* u, GLfloat* v)
{
  assert(u);
  assert(v);
  ...
  static GLvoid_glmCross(GLfloat* u, GLfloat* v, GLfloat* n)
{
  assert(u);
  assert(v);
  assert(n);
  ...
  static GLvoid_glmNormalize(GLfloat* n)
{
  GLfloat l;
  ...
  static GLboolean_glmEqual(GLfloat* u, GLfloat* v, GLfloat epsilon)
{
 ...
 static GLfloat*_glmWeldVectors(GLfloat* vectors, GLuint* numvectors, GLfloat epsilon)
{
  GLfloat* copies;
  GLuint   copied;
  GLuint   i, j;
  ...
  GLMgroup*_glmAddGroup(GLMmodel* model, char* name)
{
  ...
  GLuint_glmFindMaterial(GLMmodel* model, char* name)
{
  GLuint i;
...
static void _glmReadMTL(GLMmodel* model, char* name)
{
  ...
  static GLvoid_glmWriteMTL(GLMmodel* model, char* modelpath, char* mtllibname)
{
  FILE* file;
  char* dir;
  char* filename;
  ...
  static GLvoid_glmFirstPass(GLMmodel* model, FILE* file)
{
  GLuint    numvertices;
  GLuint    numnormals;
  GLuint    numtexcoords;
  ...
  static GLvoid_glmSecondPass(GLMmodel* model, FILE* file)
{
  GLuint    numvertices;
  GLuint    numnormals;
  GLuint    numtexcoords;
