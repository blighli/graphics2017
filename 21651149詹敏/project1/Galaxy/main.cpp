...
//  Galaxy
//
//  Created by MinBaby on 2017/3/17.
//  Copyright © 2017年 MinBaby. All rights reserved.
//
...

{
    ...
    /*绘画太阳*/
    glPushMatrix();
    glColor3f(237 / 255.0, 240 / 255.0, 0.0); // 画笔颜色
    glRotatef((GLfloat)year, 0.0, 1.0, 0.0);//太阳自转
    glutWireSphere(3.01, 20, 16);     // 画球体网格
    ...
    glutSolidTorus(0.015, 6.0, 10, 64);
    glPopMatrix();
    ...
    glColor3f(0.0, 255/255.0, 203/255.0);
...
int main(int argc, char ** argv) {
    ...
    glutInitWindowSize(1200, 900);  // 初始化窗口大小
    glutInitWindowPosition(300, 100); // 初始化位置
    glutCreateWindow("太阳系");  // 绘制
    init();
